...
if (_param isEqualTo "ejecuto") exitWith {
	...
	[10, "El dpto. penitenciario de VicioRP informa", [1,0,0], 1.5, format["Se ha impartido justicia, %1 acaba de ser ejecutado en la silla eléctrica",_nombrevictima], [1,1,1], 1] remoteexec ["ica_fnc_anuncio",-2];
};
