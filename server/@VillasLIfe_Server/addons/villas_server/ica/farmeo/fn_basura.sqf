...
if (_param isEqualTo "solicito") exitWith {
	...
	if (vicio_din < 15000) exitwith {hint "La fianza del camión son 15000 €"};
	vicio_din = vicio_din - 15000;
