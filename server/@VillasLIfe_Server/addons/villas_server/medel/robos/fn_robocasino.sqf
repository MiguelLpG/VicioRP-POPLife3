...
if (_param isEqualTo "Init") exitWith {
    ...
    _npc addAction
    [
        "<t color=""#DE2828"">" + "Robar Casino",
        {
            ["Robo"] spawn ica_fnc_robocasino;
        },
        [],
        1.5,
        true,
...
if (_param isEqualTo "Robo") exitWith {
    ...
    [10,"Alarma - Robo",[1,0,0,1],2,("Están robando el Casino"),[1,1,1,1],1.5] remoteexec ["ica_fnc_anuncio",west];

    _Pos = position player;
    _MarkerN = format ["%1_Marker",[_npc] call BIS_fnc_objectVar];
    _MarkerT = "!ATENCIÓN! Están Robando el Casino";
    ...
    hintSilent parseText format ["<t size = ""2"" color=""#DE2828"" align='center' >Robo al Casino<br/>
    ...
    ["Casino",_npc] remoteexec ["ica_fnc_check", 2];
    ...
    hint format ["En el Robo Casino se ha obtenido %1€ ", _din];
};
