...
if (vicio_din < 3000) exitWith {hint parseText "<t size = ""2"" color=""#DE2828"" align='center'>AVISO<br/><t size = ""1"" color=""#21618C"" align='left'>No tienes 3000€ para probar el vehículo.</t></t>"; closeDialog 0;};

vicio_din = vicio_din - 3000;
