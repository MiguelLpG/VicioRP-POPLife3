...
player addPrimaryWeaponItem "R3F_SILENCIEUX_FAMAS";
player addPrimaryWeaponItem "R3F_LAMPE_SURB";
player addPrimaryWeaponItem "optic_Hamr";
player addPrimaryWeaponItem "R3F_30Rnd_556x45_FAMAS";
...
for "_i" from 1 to 3 do {player addItemToUniform "R3F_30Rnd_556x45_FAMAS";};
