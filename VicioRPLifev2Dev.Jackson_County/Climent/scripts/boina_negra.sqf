...
comment "Add weapons";
player addWeapon "GG_Weaponpack_M1_Garand";
player addPrimaryWeaponItem "RH_Saker762";
player addPrimaryWeaponItem "RH_SFM952V";
player addPrimaryWeaponItem "optic_DMS";
player addPrimaryWeaponItem "GG_M1_Garand_Magazine";
...
for "_i" from 1 to 3 do {player addItemToUniform "GG_M1_Garand_Magazine";};
...
for "_i" from 1 to 20 do {player addItemToBackpack "GG_M1_Garand_Magazine";};
