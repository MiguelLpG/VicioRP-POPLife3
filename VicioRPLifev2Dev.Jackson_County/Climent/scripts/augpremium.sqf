...
comment "Add weapons";
player addWeapon "hlc_rifle_auga3_b";
player addPrimaryWeaponItem "hlc_muzzle_snds_AUG";
...
player addPrimaryWeaponItem "RH_HBLM";
...
for "_i" from 1 to 3 do {player addItemToUniform "hlc_30Rnd_556x45_B_AUG";};
...
for "_i" from 1 to 20 do {player addItemToBackpack "hlc_30Rnd_556x45_B_AUG";};
