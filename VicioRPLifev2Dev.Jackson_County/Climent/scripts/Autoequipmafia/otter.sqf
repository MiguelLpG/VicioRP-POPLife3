/*if !(getPlayerUID player isEqualTo "76561198339006590") exitWith {
	hint "No tienes permiso para comprar eso";
	closeDialog 0;
};*/

//if ("maf" call ica_fnc_expToLevel < 2) exitwith {hint "No tienes aprendido eso"}; 
...
player forceAddUniform "A3LJumperCIDBlack";
player addVest "otter_chaleco";
