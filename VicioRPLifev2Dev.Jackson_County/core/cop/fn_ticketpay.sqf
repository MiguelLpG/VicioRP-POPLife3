...
if(vicio_din < life_ticket_val) exitWith
{
	if(vicio_atmdin < life_ticket_val) exitWith
	{
	...
	vicio_atmdin = vicio_atmdin - life_ticket_val;
...
vicio_din = vicio_din - life_ticket_val;
life_ticket_paid = true;
