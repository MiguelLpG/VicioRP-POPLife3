...
waitUntil{!isNil "villas_server_isReady"};
waitUntil{(villas_server_isReady OR !isNil "villas_server_extDB_notLoaded")};
if(!isNil "villas_server_extDB_notLoaded") exitWith {
...
["Init"] spawn ica_fnc_roboalcampo;
["Init"] spawn ica_fnc_robodonador;
["Init"] spawn ica_fnc_robocasino;
["Init"] spawn ica_fnc_robohotel;
["Init"] spawn ica_fnc_roboohz;
