...
if (isnil "vicio_din") exitWith {vicio_din = 0;closeDialog 0};
...
if(vicio_din < _basePrice) exitWith {hint format[localize "STR_Shop_Veh_NotEnough",[_basePrice - vicio_din] call life_fnc_numberText];closeDialog 0;};
...
vicio_din = vicio_din - _basePrice;
call ica_fnc_sync;
