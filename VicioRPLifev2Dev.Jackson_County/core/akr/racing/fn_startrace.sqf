	...
	_this spawn {
		...
		switch(_mode) do {
			...
			case 1: {
				...
				while {inRace} do {
					hintSilent parseText format ["<t size = '1' align='center' font='TahomaB'>Carnet B </t><br/><t size='0.95' align='center'>Actual: %8</t><br/><t size='1.5'>%1</t><br/><t align='center' color='#E6D525' font='TahomaB'>Máximo: 250 seg</t>", [time - raceStartTime] call BIS_fnc_timeToString];
					sleep 0.02;
				};
			};
			case 2: {
				...
				while {inRace} do {
					hintSilent parseText format ["<t size = '1' align='center' font='TahomaB'>Carnet Camión </t><br/><t size='0.95' align='center'>Actual: %8</t><br/><t size='1.5'>%1</t><br/><t align='center' color='#E6D525' font='TahomaB'>Máximo: 260 seg</t>", [time - raceStartTime] call BIS_fnc_timeToString];
					sleep 0.02;
				};
			};
		};
