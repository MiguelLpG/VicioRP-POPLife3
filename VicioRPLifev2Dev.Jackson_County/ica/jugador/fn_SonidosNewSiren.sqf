...
/* 
Disponibles
	Jonzie_Siren - Sirena de aire EMS // Jonzie NO FUNCIONA
	Jonzie_LAPD_SIREN - Sirena de policia Wail / Jonzie NO FUNCIONA
	jonzie_LAPD_WARNING_2 - Sirena de policia Yelp / Jonzie NO FUNCIONA
	jonzie_LAPD_WARNING - Sirena de policia Prty / Jonzie NO FUNCIONA
	...
	If ( _myPos == "dri" OR (_myPos == "cop" AND side player == west ) ) Then {
		...
		If ( "poliveh" in _vehChk AND !("polinav" in _vehChk) AND !("polimoto" in _vehChk) ) Then {
			...
			switch (_CallParam) do {
				...
				case "S3": 	{ _TempSound = "bk_sirena3_Prty" };
