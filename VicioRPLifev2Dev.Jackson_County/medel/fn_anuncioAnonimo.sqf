...
if (vicio_din < 30000) exitWith {hint parsetext "<t size = ""2"" color=""#DE2828"" align='center'>POP TV <br/><t size = ""1"" color=""#21618C"" align='left'>No tienes 30000€.</t></t>";};
