...
switch (_side) do
{
	case west:
	{
		_return = [
			...
			["cop_spawn_5","Carcel","\a3\ui_f\data\map\Markers\NATO\b_air.paa"]	
			];
	};
	...
	case civilian:
	{
		_return = [
			...
			["civ_spawn_2","Old Morrison","\a3\ui_f\data\map\MapControl\watertower_ca.paa"],
  ...
  }; QUITADO PQ SPAWNEAS EN LA ISLA DE DE LOS MUERTOS*/ 
};
