class Life_FuelStat {
    ...
    class controlsBackground {
        ...
        class refuelCar: Life_RscButtonMenu {
            idc = 20309;
            text = "Refuel";
            onButtonClick = "[] spawn ANZUS_fnc_fuelRefuelCar;";
    ...
    class controls {
        class VehicleList: Life_RscListBox {
            ...
            onLBSelChanged = "_this call ANZUS_fnc_fuelLBChange";
            x = 0.11;
            y = 0.302;
            w = 0.32;
            h = 0.49;
        ...
        class fuelTank: life_RscXSliderH {
            idc = 20901;
            text = "";
            onSliderPosChanged = "[3,_this select 1] call ANZUS_fnc_s_onSliderChange;";
            tooltip = "";
            x = 0.47;
            y = .80;
