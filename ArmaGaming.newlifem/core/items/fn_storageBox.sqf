...
if (!(nearestObject [player, "House"] in life_vehicles)) exitWith {[localize "STR_ISTR_Box_NotinHouse",true,"slow"] call ANZUS_fnc_notificationSystem;};
...
[_object] remoteExecCall ["ANZUS_fnc_simDisable",RANY];
