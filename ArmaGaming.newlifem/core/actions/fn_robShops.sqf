...
if(_robber distance _shop > 10) exitWith {["You need to be within 10 meters to rob this shop!",true,"slow"] call ANZUS_fnc_notificationSystem;};
...
[format["You have recieved $%1 from the robbery, run!!",[_kassa] call ANZUS_fnc_numberText],false,"slow"] call ANZUS_fnc_notificationSystem;
[_kassa] call AnzusLife_AC_Cash;
