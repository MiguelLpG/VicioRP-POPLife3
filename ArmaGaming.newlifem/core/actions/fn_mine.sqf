...
if (vehicle player != player) exitWith {[localize "STR_ISTR_Pick_MineVeh",true,"slow"] call ANZUS_fnc_notificationSystem;};
...
_diff = [_mined, _amount, life_carryWeight, life_maxWeight] call ANZUS_fnc_calWeightDiff;
...
if (([true, _mined, _diff,"mine"] call ANZUS_fnc_handleInv)) then {
