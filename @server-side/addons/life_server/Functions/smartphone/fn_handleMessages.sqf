...
[_msg,name _player,0] remoteExec ["TON_fnc_clientMessage",_to];
 ...
 _msg = [_msg] call ANZUS_fnc_mresString;
 ...
 case 1: { 
[_msg,name _player,1,mapGridPosition _player,_player] remoteExec ["TON_fnc_clientMessage",west];
 };
 case 2: { 
[_msg,name _player,2,mapGridPosition _player,_player] remoteExec ["TON_fnc_clientMessage",0];
 };
 case 3: { 
[_msg,name _player,5,mapGridPosition _player,_player] remoteExec ["TON_fnc_clientMessage",independent];
 };
