...
switch (_mode) do {
    case 0: {
        ...
        _value = [_value] call ANZUS_fnc_numberSafe;
    ...
    case 2: {
        ...
        for "_i" from 0 to count(_value)-1 do {
            _bool = [(_value select _i) select 1] call ANZUS_fnc_bool;
            _value set[_i,[(_value select _i) select 0,_bool]];
        };
        _value = [_value] call ANZUS_fnc_mresArray;
        switch (_side) do {
    ...
    case 6: {
        ...
        _value1 = [_value1] call ANZUS_fnc_numberSafe;
        _value2 = [_value2] call ANZUS_fnc_numberSafe;
    ...
    case 8: {
        _value = [_this,2,false,[true]] call BIS_fnc_param;
        _query = format ["UPDATE players SET parole='%1' WHERE pid='%2'",_value,_uid];
    };
};
