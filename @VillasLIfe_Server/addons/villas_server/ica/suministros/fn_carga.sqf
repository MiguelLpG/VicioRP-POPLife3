...
if (trabajandocamion == true) exitwith {hint "No estas contratado en esta empresa chulo";};
...
if (_pago > vicio_din) exitWith {hint format ["Necesitas %1€ más para pagar los impuestos", _pago - vicio_din]; };
