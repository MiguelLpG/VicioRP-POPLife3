...
if (_param == "llena") exitWith {
	...
	_precio = round ((call ica_fnc_precioCombustible) * entrada);
	if !(vicio_din >= _precio) exitWith { hint parsetext "<br/><t color='#e7ad3e' size='2' shadow='1'shadowColor='#7e521c'>GASOLINERAS MEDEL</t> <br/><t color='#e7ad3e' size='2'></t> <br/><t color='#FFFFFF' size='1.5'>No tienes suficiente dinero.<t/>"; closeDialog 0; };
