...
if (_param isEqualTo "reset") exitWith {
	if (vicio_din < 150000) exitWith {hint "Esto tiene un precio, 150.000€ en concreto."};
...
if (_param isEqualTo "resetpuntos") exitWith {
	if (vicio_din < 2000000) exitWith {hint "Esto tiene un precio, 2.000.000€ en concreto."};
	vicio_din = vicio_din - 2000000;
