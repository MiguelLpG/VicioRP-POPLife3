...
if (_param isEqualTo "compro") exitWith {
	...
	if (vicio_din < 5000) exitWith {hint format ["Te faltan %1€, pero la esperanza es lo último que se pierde", 5000 - vicio_din]; closeDialog 0; ocupado = nil};
