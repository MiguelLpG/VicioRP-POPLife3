...
_costeTrabajo = 10000;
_dineroRecompensa = 60000 + _costeTrabajo;

if (_param isEqualTo "solicito") exitWith {

  if (vicio_din < _costeTrabajo) exitwith { hint parsetext format ["<t color='#DE2828'><t size='3.4'><t align='center'>CARTERO<br/><t color='#21618C'><t size='1.2'><t align='center'>La fianza de la avioneta son %1€</t>", _costeTrabajo]; };
  ...
  vicio_din = vicio_din - _costeTrabajo;
...
if (_param isEqualTo "cobro") exitWith {
  ...
  vicio_din = vicio_din + _dineroRecompensa;
