...
if (_param  isEqualTo  "Init") exitWith {
  ...
  NPC_EMPRESA_2 addAction ["<t color=""#DE2828"">" + "La Empresa: Transporte de Armas - Coste: 100.000€ - Recompensa: 150.000€",{["misionTransporteArmas"] spawn ica_fnc_empresa;},[],1.5,true,true,"","(playerside isEqualTo civilian)",5,false,"",""];
...
if (_param  isEqualTo  "misionTransporteDrogas") exitWith {
  ...
  if (vicio_din < _coste_mision) exitwith {hint parsetext "<t color='#DE2828'><t size='3.4'><t align='center'>EMPRESA<br/><t color='#21618C'><t size='1.2'><t align='center'>No tienes 40.000€.</t>";};
...
if (_param  isEqualTo "misionTransporteArmas") exitWith {
  ...
  if !({side _x isEqualTo WEST} count playableUnits >= 3) exitWith {hint parsetext "<t color='#DE2828'><t size='3.4'><t align='center'>EMPRESA<br/><t color='#21618C'><t size='1.2'><t align='center'>Tienen que estar al menos 3 policías conectados, sino, no es divertido.</t>";};
  ...
  if (vicio_din < _coste_mision) exitwith {hint parsetext "<t color='#DE2828'><t size='3.4'><t align='center'>EMPRESA<br/><t color='#21618C'><t size='1.2'><t align='center'>No tienes 100.000€.</t>";};

  ["- 100.000€"] spawn ica_fnc_infolog;
  vicio_din = vicio_din - _coste_mision;
