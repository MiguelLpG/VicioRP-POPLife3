...
while {!(isNull (findDisplay 3200))} do {
	...
	_texto ctrlSetStructuredText parsetext format ["<t size='0.97' font='PuristaMedium'> 
		Tú Nombre: %6 <br/> 
		Cartera: %7€ <br/> 
		Cuenta Bancaria: %8€ <br/> 
		<br/> 
		Policías: %1 <br/> 
		EMS: %2 <br/> 
		Civiles: %3 <br/> 
		Nivel de alerta: %4 <br/> 
		Jugadores totales: %5  <br/> 
		</t>",west countSide playableUnits, independent countSide playableUnits, civilian countSide playableUnits, (missionNamespace getVariable "nivelAlerta"), count playableUnits, name player, ([vicio_din, 3] call ica_fnc_numToStr), ([vicio_atmdin, 3] call ica_fnc_numToStr) 
	];
