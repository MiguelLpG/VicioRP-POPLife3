...
if (_param isEqualTo "Init") exitWith {
    ...
    _npc addAction
    [
        "<t color=""#DE2828"">" + "Robar Hotel Fantasma",
        {
            ["Robo"] spawn ica_fnc_robohotel;
        },
        [],
        1.5,
        true,
...
if (_param isEqualTo "Robo") exitWith {
    ...
    [10,"Alarma - Robo",[1,0,0,1],2,("Están robando el Hotel Fantasma"),[1,1,1,1],1.5] remoteexec ["ica_fnc_anuncio",west];

    _Pos = position player;
    _MarkerN = format ["%1_Marker",[_npc] call BIS_fnc_objectVar];
    _MarkerT = "!ATENCIÓN! Están Robando el Hotel Fantasma";
    ...
    hintSilent parseText format ["<t size = ""2"" color=""#DE2828"" align='center' >Robo al Hotel Fantasma<br/>
    ...
    ["Hotelf",_npc] remoteexec ["ica_fnc_check", 2];

    if (_fuera) exitWith {};

    _polisOn = {side _x == WEST} count playableUnits;

    _din = (350000 + (1000 * _polisOn));
    vicio_din = _din + vicio_din;
    hint format ["En el Robo Hotel Fantasma se ha obtenido %1€ ", _din];
};
