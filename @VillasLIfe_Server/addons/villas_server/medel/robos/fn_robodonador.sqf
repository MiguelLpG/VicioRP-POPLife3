...
if (_param isEqualTo "Init") exitWith {
    ...
    _npc addAction
    [
        "<t color=""#DE2828"">" + "Robar Base Rebelde",
        {
            ["Robo"] spawn ica_fnc_robodonador;
        },
        [],
        1.5,
        true,
...
if (_param isEqualTo "Robo") exitWith {
    ...
    [10,"Alarma - Robo",[1,0,0,1],2,("Están robando Base Rebelde"),[1,1,1,1],1.5] remoteexec ["ica_fnc_anuncio",west];

    _Pos = position player;
    _MarkerN = format ["%1_Marker",[_npc] call BIS_fnc_objectVar];
    _MarkerT = "!ATENCIÓN! Están Robando Base Rebelde";
    ...
    hintSilent parseText format ["<t size = ""2"" color=""#DE2828"" align='center' >Robo Base Rebeldeo<br/>
    ...
    ["Robo_Donador",_npc] remoteexec ["ica_fnc_check", 2];
    ...
    hint format ["En el Robo a Base Rebelde se ha obtenido %1€ ", _din];
};
