...
compileFinal "
	...
	[[vicio_atmdin,vicio_din,owner player,player],""life_fnc_admininfo"",_ret,false] call life_fnc_MP;
";
...
private[""_msg"",""_to""];
	...
	[_msg,name player,6] remoteexeccall [""clientMessage"",op];
	[] call life_fnc_cellphone;
...
compileFinal "
	...
	[_msg,name player,1] remoteexeccall [""TON_fnc_clientMessage"",0];
...
compileFinal "
	...
	[_msg,name player,2] remoteexeccall [""TON_fnc_clientMessage"",0];
	[] call life_fnc_cellphone;
	hint format[""You sent %1 a message: %2"",_to,_msg];
	ctrlShow[3017,true];
";
...
compileFinal "
	...
	[_msg,name player,4] remoteexeccall [""TON_fnc_clientMessage"",0];
	[] call life_fnc_cellphone;
