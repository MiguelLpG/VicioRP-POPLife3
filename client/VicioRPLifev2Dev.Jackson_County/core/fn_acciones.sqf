...
NPC_POP_10 addAction ["Comprar caña de pescar (3000$)", {if(isNil(primaryWeapon player)AND vicio_din >= 3000) then{vicio_din=vicio_din-3000;player addWeapon "cl_fishing_rod";}else{hint"Necesitas tener las manos desocupadas y tener dinero suficiente";}}];
/*
