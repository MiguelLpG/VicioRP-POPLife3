...
if(vicio_atmdin < (__GETC__(life_gangPrice))) exitWith {hint format[localize "STR_GNOTF_NotEnoughMoney",[((__GETC__(life_gangPrice))-vicio_atmdin)] call life_fnc_numberText];};
