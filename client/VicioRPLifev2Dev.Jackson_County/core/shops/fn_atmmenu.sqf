...
if ((isNil {vicio_din}) OR (isNil {vicio_atmdin})) exitWith {["errorica", FALSE, TRUE] call BIS_fnc_endMission;};
...
lbClear _units;
_text ctrlSetStructuredText parseText format["<img size='1.7' image='\pop_iconos\icons\bank.paa'/>  %1 €<br/><img size='1.6' image='\pop_iconos\icons\money.paa'/>  %2 €",[vicio_atmdin] call life_fnc_numberText,[vicio_din] call life_fnc_numberText];
