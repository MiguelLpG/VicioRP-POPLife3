...
comment "Add weapons";
player addWeapon "R3F_FRF2";
player addPrimaryWeaponItem "R3F_SILENCIEUX_FRF2";
player addPrimaryWeaponItem "R3F_NF42";
player addPrimaryWeaponItem "R3F_10Rnd_762x51_FRF2";
...
for "_i" from 1 to 3 do {player addItemToUniform "R3F_10Rnd_762x51_FRF2";};
